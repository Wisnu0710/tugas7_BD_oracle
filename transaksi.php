      ...
      <!--- tambah data -->
              <form class="form-horizontal" action="add_transaksi.php" method="post">
               <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="tgl_kadarluasa" placeholder="TGL_KADARLUASA">
                </div> 
                <div class="form-group col-md-6">
                ...
                <div class="from-group col-md-6">
                  ...
                  <input type="text" class="from-control" name="nama_obat" placeholder="NAMA_OBAT">
                </div>
                <div class="from-group col-md-6">
                  <label for="">HARGA</label>
                  <input type="text" class="from-control" name="harga" placeholder="HARGA">
                </div>
              ...
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Data Transaski</h4>
    ...
    while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
      ?>
                        <tr>                          
                          ...
                          <td class="td-actions">
              <a href="up_transaksi.php?id=<?= $d['ID_PESANAN'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
              <a href="del_transaksi.php?id=<?= $d['ID_PESANAN'] ?>" 
